...
*DictPatchApi* | [**dict_patch**](docs/DictPatchApi.md#dict_patch) | **PATCH** /dict/{slug}/{code} | Обновляет данные справочника
*DictPutApi* | [**dict_put**](docs/DictPutApi.md#dict_put) | **PUT** /dict/{slug}/{code} | Обновляет данные справочника
