...
class DictApi(object):
    ...
    def dict_post(self, slug, **kwargs):  # noqa: E501
        """Обновляет данные справочника  # noqa: E501

        Обновляет данные справочника  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dict_post(slug, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.dict_post_with_http_info(slug, **kwargs)  # noqa: E501
        else:
            (data) = self.dict_post_with_http_info(slug, **kwargs)  # noqa: E501
            return data

    def dict_post_with_http_info(self, slug, **kwargs):  # noqa: E501
        """Обновляет данные справочника  # noqa: E501

        Обновляет данные справочника  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dict_post_with_http_info(slug, async_req=True)
        >>> result = thread.get()
        ...
        if ('slug' not in params or
                params['slug'] is None):
            raise ValueError("Missing the required parameter `slug` when calling `dict_post`")  # noqa: E501
